...
function plot_freq_response(plots, path, mode)
    ...
    for i = 1:length(plots)
        ...
        elseif mode == "points"
            plot(omega, mag, 'LineWidth', 1.8, 'LineStyle', style, 'Color', color, 'Marker', 'o', 'MarkerSize', 5);
        end    
        hold on;
    end
    xlabel('\omega (rad/s)')
    ...
    for i = 1:length(plots)
        ...
        elseif mode == "points"
            plot(omega, phase, 'LineWidth', 1.8, 'LineStyle', style, 'Color', color, 'Marker', 'o', 'MarkerSize', 5);
        end   
        hold on; 
    end
